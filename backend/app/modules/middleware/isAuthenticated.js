...
const projection = ['userName', 'emailAddress'];
...
module.exports = {
    verifyToken: async (req, res, next) => {
        try {
            ...
            const getRefreshToken = await CacheRepository.getSession(`${isAccessTokenValid.data.userName}_${deviceId}`);
            ...
            Logging.error(`[VERIFY][TOKEN][MIDDLEWARE] >>>>> ${JSON.stringify(err.stack)}`);
